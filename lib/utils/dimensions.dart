...
class Dimensions {
  ...
  static double fontSizeSmall = width >= 1300 ? 14 : 12;
  static double fontSizeDefault = width >= 1300 ? 16 : 14;
  static double fontSizeLarge = width >= 1300 ? 18 : 16;
  static double fontSizeExtraLarge = width >= 1300 ? 20 : 18;
  static double fontSizeOverLarge = width >= 1300 ? 26 : 24;
  static double fontSizeForReview = width >= 1300 ? 36 : 36;
  ...
  static const double webMaxWidth = 1260;
  ...
  ///wallet
  static const double walletTopCardHeight = 170;
  static const double currencyConvertButtonHeight = 220;

  static appWidth(BuildContext context) {
    return MediaQuery.of(context).size.width;
  }

  static appHeight(BuildContext context) {
